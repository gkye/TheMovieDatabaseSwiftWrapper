...
class DiscoverMovieMDB: DiscoverMDB{
    ...
    class func discoverMovies(api_key: String, language: String?, page: Double?, sort_by: String?, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
    ...
    class func discoverMovies(api_key: String, primary_release_date_gte: String?, primary_release_date_lte: String?, language: String?, page: Double?, sort_by: String?, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
    ...
    class func discoverMoviesWith(api_key: String, with_genres: String?, with_cast: String?, with_crew: String?, with_companies: String?,with_keywords: String?, with_people: String?, with_networks: String?, year: Float?, sort_by: String?, page: Double, language: String, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){

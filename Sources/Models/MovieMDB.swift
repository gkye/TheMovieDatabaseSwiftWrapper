...
extension MovieMDB{
  ...
  public class func movie(api_key: String!, movieID: Int!, language: String? = nil , completion: (clientReturn: ClientReturn, data: MovieDetailedMDB?) -> ()) -> (){
  ...
  public class func alternativeTitles(api_key: String!, movieID: Int!, country: String? = nil, completion: (clientReturn: ClientReturn, altTitles: Alternative_TitlesMDB?) -> ()) -> (){
  ...
  public class func images(api_key: String!, movieID: Int!, language: String?  = nil, completion: (clientReturn: ClientReturn, images: ImagesMDB?) -> ()) -> (){
  ...
  public class func videos(api_key: String!, movieID: Int!, language: String?  = nil, completion: (clientReturn: ClientReturn, videos: [VideosMDB]?) -> ()) -> (){
  ...
  public class func similar(api_key: String!, movieID: Int!, page: Int?, language: String? = nil, completion: (clientReturn: ClientReturn, movie: [MovieMDB]?) -> ()) -> (){
  ...
  public class func reviews(api_key: String!, movieID: Int!, page: Int?, language: String? = nil, completion: (clientReturn: ClientReturn, reviews: [MovieReviewsMDB]?) -> ()) -> (){
  ...
  public class func list(api_key: String!, movieID: Int!, page: Int?, language: String? = nil, completion: (clientReturn: ClientReturn, list: [MovieListMDB]?) -> ()) -> (){
  ...
  public class func nowplaying(api_key: String!,language: String? = nil, page: Int?, completion: (clientReturn: ClientReturn, movie: [MovieMDB]?) -> ()) -> (){
  ...
  public class func popular(api_key: String!,language: String? = nil, page: Int?, completion: (clientReturn: ClientReturn, movie: [MovieMDB]?) -> ()) -> (){
  ...
  public class func toprated(api_key: String!,language: String? = nil, page: Int?, completion: (clientReturn: ClientReturn, movie: [MovieMDB]?) -> ()) -> (){
  ...
  public class func upcoming(api_key: String!, page: Int?, language: String?  = nil, completion: (clientReturn: ClientReturn, movie: [MovieMDB]?) -> ()) -> (){
   ...
   */
  public class func movieAppendTo(api_key: String!, movieID: Int!, append_to: [String], language: String? = nil, completion: (clientReturn: ClientReturn, data: MovieDetailedMDB?, json: JSON?) -> ()) -> (){
    Client.Movies("\(movieID)", api_key: api_key, page: nil, language: language, append_to: append_to){
      apiReturn in
      var detailed = MovieDetailedMDB?()
      if(apiReturn.error == nil){
        detailed = MovieDetailedMDB.init(results: apiReturn.json!)
      }
      completion(clientReturn: apiReturn, data: detailed, json: apiReturn.json)
    }
  }
}

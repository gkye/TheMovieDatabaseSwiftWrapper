...
public class DiscoverTVMDB: DiscoverMDB {
  ...
  public class func discoverTV(api_key: String, language: String?, sort_by: String? = nil, page: Double?, completionHandler: (clientReturn: ClientReturn, data: [TVMDB]?) -> ()) -> (){
  ...
  public class func discoverTV(api_key: String, first_air_date_year: String? = nil, first_air_date_gte: String? = nil, first_air_date_lte: String? = nil, air_date_gte: String? = nil, air_date_lte: String? = nil, language: String?, sort_by: String? = nil, page: Double?, timezone: String? = nil, completionHandler: (clientReturn: ClientReturn, data: [TVMDB]?) -> ()) -> (){
  ...
  public class func discoverTVWith(api_key: String, with_genres: String? = nil, with_networks: String? = nil, sort_by: String? = nil, language: String?, page: Double?, completionHandler: (clientReturn: ClientReturn, data: [TVMDB]?) -> ()) -> (){

...
public class DiscoverMovieMDB: DiscoverMDB{
  ...
  public class func discoverMovies(api_key: String, language: String?, page: Double?, sort_by: String? = nil, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
  ...
  public class func discoverMovies(api_key: String, sort_by: String? = nil, certification_country: String? = nil, certification: String? = nil, certification_lte: String? = nil, certification_gte: String? = nil, include_adult: Bool?, include_video: Bool? = nil, primary_release_year: String? = nil, primary_release_date_gte: String? = nil, primary_release_date_lte: String? = nil, release_date_gte: String? = nil, release_date_lte: String? = nil, language: String?, page: Double?, vote_average_gte: Double? = nil, vote_average_lte: Double? = nil, vote_count_gte: Double? = nil, vote_count_lte: Double? = nil, with_cast: String? = nil, with_crew: String? = nil, with_companies: String? = nil, with_genres: String?, with_keywords: String?, with_people: String?, with_networks: String?, year: Float?, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
  ...
  public class func discoverMovies(api_key: String, primary_release_date_gte: String? = nil, primary_release_date_lte: String? = nil, language: String? = nil, page: Double? = nil, sort_by: String? = nil, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
  ...
  public class func discoverMoviesWith(api_key: String, with_genres: String? = nil, with_cast: String? = nil, with_crew: String? = nil, with_companies: String? = nil, with_keywords: String? = nil, with_people: String? = nil, with_networks: String? = nil, year: Float? = nil, sort_by: String? = nil, page: Double, language: String, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){
  ...
  public class func genreList(api_key: String!, genreId: Int, page: Double?, include_all_movies: Bool? = nil, include_adult: Bool? = nil, movieList: Bool? = nil, completion: (clientReturn: ClientReturn, data: [MovieMDB]?) -> ()) -> (){

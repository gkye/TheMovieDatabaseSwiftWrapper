...
public class DiscoverMDB: ArrayObject {
  ...
  public  class func discover(api_key: String, discoverType: String!, language: String?, sort_by: String? = nil, page: Double?,completionHandler: (ClientReturn) -> ()) -> (){
  ...
  public class func discover(api_key: String, discoverType: String!, language: String?, sort_by: String? = nil, page: Double?, with_genres: String? = nil, completionHandler: (ClientReturn) -> ()) -> (){
  ...
  public class func discover(api_key: String, discoverType: String!, language: String?, sort_by: String? = nil,  page: Double?, with_genres: String? = nil?, vote_average_gte: Double?, vote_count_gte: Double?, completionHandler: (ClientReturn) -> ()) -> (){
  ...
  public class func discoverByRating(api_key: String, discoverType: String, certification: String, certification_country: String, ceritfication_lte: String? = nil, ceritfication_gte: String? = nil,  sort_by: String? = nil, page: Double?,  language: String?,  completionHandler: (ClientReturn) -> ()) -> (){

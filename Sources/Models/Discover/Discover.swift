...
open class DiscoverMDB: ArrayObject {
  ...
  public class func discoverByRating(_ api_key: String, discoverType: String, certification: String, certification_country: String, ceritfication_lte: String? = nil, ceritfication_gte: String? = nil,  sort_by: String? = nil, page: Double?,  language: String?,  completionHandler: @escaping (ClientReturn) -> ()) -> (){

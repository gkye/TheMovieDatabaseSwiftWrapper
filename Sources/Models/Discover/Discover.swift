...
open class DiscoverMDB: ArrayObject {
	...
	public class func discover(apiKey: String, discoverType: DiscoverType, params: [DiscoverParam]){
...
//		Client.discover(apiKey, baseURL: discoverType.rawValue, params: params)
	}

...
public class DiscoverSortBy  {
    
    public let popularity_asc = "popularity.asc";
    public let popularity_desc = "popularity_desc";
    public let vote_average_asc = "vote_average.asc";
    public let vote_average_desc = "vote_average.desc";
}

public class DiscoverSortByMovie: DiscoverSortBy {
    internal var release_date_asc = "release_date.asc";
    public let release_date_desc = "release_date.desc";
    public let revenue_asc = "revenue.asc";
    public let revenue_desc = "revenue.desc";
    public let primary_release_date_asc = "primary_release_date.asc";
    public let primary_release_date_desc = "primary_release_date.desc";
    public let original_title_asc = "original_title.asc";
    public let original_title_desc = "original_title.desc";
    public let vote_count_asc = "vote_count.asc";
    public let vote_count_desc = "vote_count.desc";
    
}

public class DiscoverSortByTV: DiscoverSortBy {
    public let first_air_date_desc = "first_air_date.desc";
    public let first_air_date_asc = "first_air_date.asc";
}
